let education = `CREATE TABLE IF NOT EXISTS education (
  ...
  type varchar(40) NOT NULL DEFAULT 'Master Industrial Engineering',
  institution varchar(40) NOT NULL DEFAULT 'KU Leuven',
  date_from int(20) NOT NULL,
  date_until int(20) NOT NULL,
  PRIMARY KEY (id),
