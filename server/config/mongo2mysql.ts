...
app.get('/api/filesync-user', (req, res) => {
    ...
    const filesync = JSON.parse(fs.readFileSync('./server/config/users.json', 'utf8'));

    for (let i = 0; i < filesync.length; i++) {
        const sql = `INSERT INTO user SET rnumber = '${filesync[i].rnumber}', email= '${filesync[i].email}', role = 'Student'`;
...
app.get('/api/filesync-student', (req, res) => {
    ...
    const filesync = JSON.parse(fs.readFileSync('./server/config/students.json', 'utf8'));

    for (let i = 0; i < filesync.length; i++) {
        const sql = `SELECT id FROM user WHERE rnumber = '${filesync[i].rnumber}'`;
        pool.getConnection(function (error, connection) {
            const query = connection.query(sql, (err, result) => {
                if (err) {
                    connection.release();
                ...
                const sql1 = `INSERT INTO students SET name = '${filesync[i].name}',
...
app.get('/api/filesync-cvs', (req, res) => {
    ...
    const filesync = JSON.parse(fs.readFileSync('./server/config/cvs.json', 'utf8'));

    for (let i = 0; i < filesync.length; i++) {
        const sql = `SELECT id FROM students WHERE rnumber = '${filesync[i].name}'`;
        pool.getConnection(function (error, connection) {
            const query = connection.query(sql, (err, result) => {
                if (err) {
                    connection.release();
                ...
                const sql1 = `INSERT INTO cvs SET  name = '${filesync[i].name}',
...
app.get('/api/filesync-other', (req, res) => {
    ...
    for (let i = 0; i < filesync.length; i++) {
        const sql = `SELECT id FROM students WHERE rnumber = '${filesync[i].rnumber}'`;
        pool.getConnection(function (error, connection) {
            const query = connection.query(sql, (err, result) => {
                if (err) {
                    connection.release();
                ...
                if (filesync[i].contact) {
                    const sql1 = `INSERT INTO contact SET email = '${filesync[i].contact[0]}',
                                              phone = '${filesync[i].contact[1]}',
                                              county = '${filesync[i].contact[2]}',
                                              city = '${filesync[i].contact[3]}',
                                              student_fk = '${result[0].id}'`;
                    const query1 = connection.query(sql1, (err1, result1) => {
                        if (err1) {
                            connection.release();
                            throw err1;
                        }
                    ...
                    const sql3 = `INSERT INTO contact SET student_fk = '${result[0].id}'`;
                    const query3 = connection.query(sql3, (err3, result3) => {
                        if (err3) {
                            connection.release();
                            throw err3;
                        }
                ...
                if (filesync[i].education[0] && filesync[i].education[1]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[0]}',
                                                institution = '${filesync[i].education[1]}',
                                                date_from = '${filesync[i].educationDate[0]}',
                                                date_until = '${filesync[i].educationDate[1]}',
                                                student_fk = '${result[0].id}'`;
                    const query2 = connection.query(sql2, (err2, result2) => {
                        if (err2) {
                            connection.
                                connection.release(); 
                            throw err2;
                    ...
                    const sql3 = `INSERT INTO education SET student_fk = '${result[0].id}'`;
                    const query3 = connection.query(sql3, (err3, result3) => {
                        if (err3) {
                            connection.release();
                            throw err3;
                ...
                if (filesync[i].education[2] && filesync[i].education[3]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[2]}',
                ...
                if (filesync[i].education[4] && filesync[i].education[5]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[4]}',
                ...
                if (filesync[i].education[6] && filesync[i].education[7]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[6]}',
                ...
                if (filesync[i].education[8] && filesync[i].education[9]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[8]}',
                ...
                if (filesync[i].education[10] && filesync[i].education[11]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[10]}',
                ...
                if (filesync[i].education[12] && filesync[i].education[13]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[12]}',
                ...
                if (filesync[i].education[14] && filesync[i].education[15]) {
                    const sql2 = `INSERT INTO education SET type = '${filesync[i].education[14]}',
                ...
                if (filesync[i].experiences[0] && filesync[i].experiences[1] && filesync[i].experiences[2]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[0]}',
                    ...
                    const sql3 = `INSERT INTO experiences SET student_fk = '${result[0].id}'`;
                    const query3 = connection.query(sql3, (err3, result3) => {
                        if (err) {
                            connection.release();
                            throw err;
                ...
                if (filesync[i].experiences[3] && filesync[i].experiences[4] && filesync[i].experiences[5]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[3]}',
                ...
                if (filesync[i].experiences[6] && filesync[i].experiences[7] && filesync[i].experiences[8]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[6]}',
                ...
                if (filesync[i].experiences[9] && filesync[i].experiences[10] && filesync[i].experiences[11]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[9]}',
                ...
                if (filesync[i].experiences[12] && filesync[i].experiences[13] && filesync[i].experiences[14]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[12]}',
                ...
                if (filesync[i].experiences[15] && filesync[i].experiences[16] && filesync[i].experiences[17]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[15]}',
                ...
                if (filesync[i].experiences[18] && filesync[i].experiences[19] && filesync[i].experiences[20]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[18]}',
                ...
                if (filesync[i].experiences[21] && filesync[i].experiences[22] && filesync[i].experiences[23]) {
                    const sql1 = `INSERT INTO experiences SET function = '${filesync[i].experiences[21]}',
                ...
                if (filesync[i].language[0] && filesync[i].languageValue[0] && filesync[i].languageValue[1]) {
                    const sql1 = `INSERT INTO language SET type = '${filesync[i].language[0]}',
                    ...
                    const sql3 = `INSERT INTO language SET student_fk = '${result[0].id}'`;
                    const query3 = connection.query(sql3, (err3, result3) => {
                        if (err) {
                            connection.release();
                            throw err;
                ...
                if (filesync[i].language[1] && filesync[i].languageValue[2] && filesync[i].languageValue[3]) {
                    const sql1 = `INSERT INTO language SET type = '${filesync[i].language[1]}',
                ...
                if (filesync[i].language[2] && filesync[i].languageValue[4] && filesync[i].languageValue[5]) {
                    const sql1 = `INSERT INTO language SET type = '${filesync[i].language[2]}',
                ...
                if (filesync[i].language[3] && filesync[i].languageValue[6] && filesync[i].languageValue[7]) {
                    const sql1 = `INSERT INTO language SET type = '${filesync[i].language[3]}',
                ...
                if (filesync[i].language[4] && filesync[i].languageValue[8] && filesync[i].languageValue[9]) {
                    const sql1 = `INSERT INTO language SET type = '${filesync[i].language[4]}',
                ...
                if (filesync[i].language[5] && filesync[i].languageValue[10] && filesync[i].languageValue[11]) {
                    const sql1 = `INSERT INTO language SET type = '${filesync[i].language[5]}',
                ...
                if (filesync[i].professional[0] && filesync[i].professionalValue[0] && filesync[i].professionalValue[1]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[0]}',
                    ...
                    const sql3 = `INSERT INTO professional SET student_fk = '${result[0].id}'`;
                    const query3 = connection.query(sql3, (err3, result3) => {
                        if (err) {
                            connection.release();
                            throw err;
                ...
                if (filesync[i].professional[1] && filesync[i].professionalValue[2] && filesync[i].professionalValue[3]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[1]}',
                ...
                if (filesync[i].professional[2] && filesync[i].professionalValue[4] && filesync[i].professionalValue[5]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[2]}',
                ...
                if (filesync[i].professional[3] && filesync[i].professionalValue[6] && filesync[i].professionalValue[7]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[3]}',
                ...
                if (filesync[i].professional[4] && filesync[i].professionalValue[8] && filesync[i].professionalValue[9]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[4]}',
                ...
                if (filesync[i].professional[5] && filesync[i].professionalValue[10] && filesync[i].professionalValue[11]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[5]}',
                ...
                if (filesync[i].professional[6] && filesync[i].professionalValue[12] && filesync[i].professionalValue[13]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[6]}',
                ...
                if (filesync[i].professional[7] && filesync[i].professionalValue[14] && filesync[i].professionalValue[15]) {
                    const sql1 = `INSERT INTO professional SET skill = '${filesync[i].professional[7]}',
                ...
                if (filesync[i].skills[0] && filesync[i].skillsValue[0] && filesync[i].skillsValue[1]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[0]}',
                    ...
                    const sql3 = `INSERT INTO skills SET student_fk = '${result[0].id}'`;
                    const query3 = connection.query(sql3, (err3, result3) => {
                        if (err) {
                            connection.release();
                            throw err;
                ...
                if (filesync[i].skills[1] && filesync[i].skillsValue[2] && filesync[i].skillsValue[3]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[1]}',
                ...
                if (filesync[i].skills[2] && filesync[i].skillsValue[4] && filesync[i].skillsValue[5]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[2]}',
                ...
                if (filesync[i].skills[3] && filesync[i].skillsValue[6] && filesync[i].skillsValue[7]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[3]}',
                ...
                if (filesync[i].skills[4] && filesync[i].skillsValue[8] && filesync[i].skillsValue[9]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[4]}',
                ...
                if (filesync[i].skills[5] && filesync[i].skillsValue[10] && filesync[i].skillsValue[11]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[5]}',
                ...
                if (filesync[i].skills[6] && filesync[i].skillsValue[12] && filesync[i].skillsValue[13]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[6]}',
                ...
                if (filesync[i].skills[7] && filesync[i].skillsValue[14] && filesync[i].skillsValue[15]) {
                    const sql1 = `INSERT INTO skills SET skill = '${filesync[i].skills[7]}',
                ...
                //   const sql1 = `INSERT INTO socialmedia SET type = 'null',
                ...
                //   });
                // }else{
                //   const sql3 = `INSERT INTO socialmedia SET student_fk = '${result[0].id}'`;
                //   const query3 = connection.query(sql3, (err3, result3) => {
                //       if(err) throw err;
                connection.release();
                //   });
